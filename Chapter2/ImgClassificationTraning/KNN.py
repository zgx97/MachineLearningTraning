...
def sugerHandWritingClassTest(k):
    hwLabels = []
    # 训练集
    trainingFileList = listdir("./digits/trainingDigits")
    m = len(trainingFileList)
    ...
    # print "\nthe total number of errors is: %d" % errorCount
    fp = open("./log.txt", "a")
    fp.writelines("%s\n" % str(errorCount / float(mTest)))
    fp.close()
    

if __name__ == "__main__":
    img2vector("/home/zgx/Document/GitHub/MachineLearningTraning/Chapter2/ImgClassificationTraning/digits/trainingDigits/0_3.txt")
